...
//        $stylesheet_uri = $stylesheet_dir_uri . '/css/new-style.css';
//    } else{
...
function locale_stylesheet() {
	...
	if ( empty($stylesheet) )
		return;
	echo '<link rel="preload" href="'.$stylesheet.'" as="style" onload="this.onload=null;this.rel=\'stylesheet\'">';
    echo '<noscript><link rel="stylesheet" href="'.$stylesheet.'"></noscript>';
}
