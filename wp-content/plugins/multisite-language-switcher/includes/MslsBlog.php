...
class MslsBlog {
	 ...
	 */
	public function __construct( $obj, $description, $blog_order ) {
		if ( is_object( $obj ) ) {
			$this->obj      = $obj;
    ...
    /**
     * Get the blog order stored in this object
     *
     * The method returns the stored language if the description is empty.
     * @return string
     */
     ...
     * @return int
     */
    public static function blog_order( MslsBlog $a, MslsBlog $b ) {
        return ( self::_cmp( $a->get_blog_order(), $b->get_blog_order() ) );
    }
