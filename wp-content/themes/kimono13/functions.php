...
//	wp_enqueue_script( 'twentytwelve-navigation', get_template_directory_uri() . '/js/navigation.js', array( 'jquery' ), '20140318', true );
	...
	wp_enqueue_style('font-icon', get_template_directory_uri() . '/css/font-icon.css');
	wp_enqueue_style('font-icon-shop', get_template_directory_uri() . '/css/font-icon-shop.css');
	wp_enqueue_style( 'header' , get_template_directory_uri()  . '/css/header.css');
	wp_enqueue_style( 'footer' , get_template_directory_uri()  . '/css/footer.css');
	wp_enqueue_style( 'style-one-column' , get_template_directory_uri()  . '/css/style-one-column.css');
	wp_enqueue_style( 'style-smartphone',get_template_directory_uri()  . '/css/style-smartphone.css' );
	wp_enqueue_style( 'slidebars', get_template_directory_uri()  . '/css/slidebars.css' );
	wp_enqueue_style( 'slidebars-custom' , get_template_directory_uri()  . '/css/slidebars-custom.css');
	...
	wp_enqueue_style( 'custom-scroll-css', get_template_directory_uri()  . '/css/jquery.mCustomScrollbar.min.css',array() );
	wp_enqueue_script( 'custom-scroll-js', get_template_directory_uri() . '/js/jquery.mCustomScrollbar.concat.min.js', array(), true );	
...
<!--			<div class="nav-previous"><?php // previous_posts_link ( __( '<span class="meta-nav">&larr;</span> Older posts', 'twentytwelve' ) ); ?></div>
			...
			<div class="nav-previous"><?php previous_posts_link ( __( '<span class="meta-nav"><</span> 前の記事へ', 'twentytwelve' ) ); ?></div>
			<div class="nav-next"><?php next_posts_link( __( '次の記事へ <span class="meta-nav">></span>', 'twentytwelve' ) ); ?></div>
