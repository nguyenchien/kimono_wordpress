							...
							<div class="right-column right-column-list">
								<div class="wrap-customer-remark">
									...
									<div class="customer-remark-wrap">
										...
										<div style="text-align: center;"><div class="paging-customer-remark"><?php wp_pagenavi(array('query' => $the_query, 'options' => array(
                                                    'first_text' => 1,
                                                    'last_text' => $total_pages,
													'prev_text' => '<span class="paging-nav prev"></span>',
													'next_text' => '<span class="paging-nav next"></span>')) ); ?></div>
										</div>
									</div>
								</div>
								<?php // End content ?>
