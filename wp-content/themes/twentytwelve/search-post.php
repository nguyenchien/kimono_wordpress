...
get_header('formal');
global $post, $custom_taxonomies, $column_query_var;
...
$banner_list = array(
    ...
    'furisode-column'  => array(
        ...
        'img'   => WP_HOME.'/images/formal-rental/main-banner-fm-furisode.jpg',
        'alt'   => '振袖レンタルTOP',
        'title_h4' => '振袖の豆知識コラム',
    ...
    'column_hakama'    => array(
        ...
        'img'   => WP_HOME.'/images/formal-rental/main-banner-fm-hakama.jpg',
        'alt'   => '袴のレンタルTOP',
        'title_h4' => '袴の豆知識コラム',
    ...
    'ubugi-column'     => array(
        ...
        'img'   => WP_HOME.'/images/formal-rental/main-banner-fm-ubugi.jpg',
        'alt'   => '産着のレンタルTOP',
        'title_h4' => '産着の豆知識コラム',
    ...
    'homongi-column'   => array(
        ...
        'img'   => WP_HOME.'/images/formal-rental/main-banner-fm-homongi.jpg',
        'alt'   => '訪問着レンタルTOP',
        'title_h4' => '訪問着の豆知識コラム',
    ...
    'kurotomesode-column' => array(
        ...
        'img'   => WP_HOME.'/images/formal-rental/main-banner-fm-irotomesode.jpg',
        'alt'   => '留袖（黒留袖・色留袖）レンタルTOP'
    ),
    'irotomesode-column' => array(
        'title' => '＼色留袖のレンタルはこちら／',
        'link'  => home_url().'/formal/irotomesode/iro_tomesode',
        'img'   => WP_HOME.'/images/formal-rental/main-banner-fm-irotomesode.jpg',
        'alt'   => '色留袖レンタルTOP',
        'title_h4' => '訪問着の豆知識コラム',
								...
								<div class="section-new-formal wrap-formal-blog">
                                    ...
                                    <div class="wrap-banner-formal column-banner">
                                        <h1 class="row">
                                            ...
                                            <?php else: ?>
                                                <img class="sp" src="<?php echo WP_HOMES; ?>/images/formal-rental/column-banner-sp.jpg" alt="<?php echo Yii::t('wp_theme.column', 'column_'.$column_query_var.'_title'); ?>">
                                            <?php endif; ?>
                                        </h1>
                                    </div>
											...
											<div class="wrap-list-col-cate active" id="news-article">
                                                <header class="page-header">
                                                    <?php if (array_key_exists($column_query_var, $column_parse_link)) : ?>
                                                        <h2 class="page-title"><?php echo Yii::t('wp_theme.column', 'column_'.$column_query_var.'_title'); ?></h2>
                                                    <?php else: ?>
                                                        <h2 class="page-title"><?php printf( __( 'Search Results for: %s', 'twentytwelve' ), '<span>' . get_search_query() . '</span>' ); ?></h2>
                                                    <?php endif; ?>
                                                </header>

                                                <div class="wrap-articles-column">
                                                    <ul class="list-articles-column">
                                                            ...
                                                            array(
                                                                ...
                                                                'tax_query' => array(
                                                                    array(
                                                                        'taxonomy' => 'category',
                                                                        'field' => 'slug',
                                                                        'terms' => $query_var_mapping[$column_query_var] ? $query_var_mapping[$column_query_var] : '',
                                                                    )
                                                                ),
                                                                'paged'=>$paged,
                                                            )
                                                        ...
                                                        if ($posts) {
                                                            foreach ($posts as $post) {
                                                                $img_post = has_post_thumbnail($post->ID) ? swe_get_the_post_thumbnail($post->ID) : '<img src="'.WP_HOME.'/images/no-image.png" alt="'.get_the_title().'">';
                                                                ?>
                                                                <li class="article-column flexbox">
                                                                    ...
                                                                    <div class="info-article-column">
                                                                        ...
                                                                        <h3 class="title-article-column"><a href="<?php echo get_permalink($post->ID); ?>"><?php echo get_the_title($post->ID); ?></a></h3>
                                                                        <p class="desc-article-column"><a href="<?php echo get_permalink($post->ID); ?>"><?php echo wp_trim_words( $post->post_content, 100, '...' ); ?></a></p>
                                                                        <?php
                                                                ...
                                                                <a href="<?=$banner_meta['link']?>">
                                                                    ...
                                                                    <?php if (!empty($banner_meta['img'])) { ?>
                                                                        <div class="image-banner">
                                                                            <img alt="<?=$banner_meta['alt']?>" src="<?=$banner_meta['img']?>" />
                                                                        </div>
                                                                    <?php } ?>
                                                                </a>
                                                            </li>
