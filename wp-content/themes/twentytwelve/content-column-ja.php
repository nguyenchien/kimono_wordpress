...
$img = has_post_thumbnail() ? swe_get_the_post_thumbnail($post->ID, array(271,275)) : '<img src="'.WP_HOME.'/images/no-image.png" alt="'.get_the_title().'">';
	...
	<div class="box-content-cate flexbox">
		...
		<div class="info-inner-cate">
			<div class="wrap-post-date flexbox pc">
				...
				<div class="pc wrap-feature"><?= Yii::t ('new_kimono_spot','特集')?></div>
			</div>
			...
			<div class="box-bottom-inner-info flexbox justify-content-between">
				<div class="wrap-view-feature flexbox">
					<div class="sp wrap-feature"><?= Yii::t ('new_kimono_spot','特集')?></div>
					<div class="wrap-num-view flexbox"><span class="num-view"><?php echo $view_count; ?></span><span class="name-view">view</span></div>
				</div>
				<div class="read-more-info"><a href="<?php the_permalink() ?>" alt="<?php the_title(); ?>"><span>&gt;</span><?= Yii::t ('new_kimono_spot','記事を読む')?></a></div>
			</div>
		</div>
	</div>
</li>