...
jQuery(function () {
    ...
    mapList.push(
        {
            longLats: [{latitude: 35.004704, longitude: 135.767149}], //清水坂店
            elementId: 'formal-shop-2',
            options: {mapTypeControlOptions: {}, draggable: true}
        }
    );
    mapList.push(
        {
            longLats: [{latitude: 34.998496, longitude: 135.780745}], //京都駅前京都タワー店
            elementId: 'formal-shop-5',
            options: {mapTypeControlOptions: {}, draggable: true}
        }
    );
	mapList.push(
    ...
    mapList.push(
        {
            longLats: [{latitude: 36.5624746, longitude: 136.6532506}],//金沢香林坊店　kanazawa,
            elementId: 'formal-shop-10',
            options: {mapTypeControlOptions: {}, draggable: true}
        }
    );
    mapList.push(
        {
            longLats: [{latitude: 35.0179236, longitude: 135.6810972}], //嵐山駅前店
            elementId: 'formal-shop-11',
            options: {mapTypeControlOptions: {}, draggable: true}
        }
    );
    mapList.push(
        {
            longLats: [{latitude: 35.0051966, longitude: 135.7730540}], //プチ祇園四条店
            elementId: 'formal-shop-14',
            options: {mapTypeControlOptions: {}, draggable: true}
        }
    );
    mapList.push(
        {
            longLats: [{latitude: 34.9880993, longitude: 135.7553967}], //プチ京都駅前店
            elementId: 'formal-shop-15',
            options: {mapTypeControlOptions: {}, draggable: true}
        }
    );
    mapList.push(
    ...
    mapList.push(
        {
            longLats: [{latitude: 35.0179165, longitude: 135.681116}], // Tokyoskytree
            elementId: 'formal-shop-18',
            options: {mapTypeControlOptions: {}, draggable: true}
        }
    );
    mapList.push(
        {
            longLats: [{latitude: 36.56237, longitude: 136.653114}], // Dazaifu
            elementId: 'formal-shop-20',
            options: {mapTypeControlOptions: {}, draggable: true}
        }
    );
