...
<script id="lazy" src="<?php echo WP_HOME; ?>/js/lib/lazyload.utils.js?v=12125" type="text/javascript"></script>
<style><?php include Yii::getPathOfAlias('webroot').'/css/lazyload.utils.css' ?></style>
...
<script type="text/javascript">
	console.log('asyn support', window.lazy && window.lazy.async, document.scripts.lazy && document.scripts.lazy.async, document.scripts[0] && document.scripts[0].async, document.scripts[0].src)
...
<script src="//www.kyotokimono-rental.jp/js/sherlog.min.js" data-environment="<?=$_SERVER['SERVER_NAME']=='before.kyotokimono-rental.com'?'before':'product'?>"></script>
<script>
console.log('asyn support', window.lazy && window.lazy.async, document.scripts.lazy && document.scripts.lazy.async, document.scripts[0] && document.scripts[0].async, document.scripts[0].src)
</script>
<!-- BEGIN TRACKJS -->
<script type="text/javascript">window._trackJs = { token: '9907572e716a477ba5996fcfe75fa1e9' };</script>
