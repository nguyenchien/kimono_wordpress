                            ...
                            <ul>
                                ...
                                <li class="top-footer-menu-item sns">
                                    ...
                                    <ul class="top-footer-sub-menu">
                                        ...
                                        <li class="top-footer-sub-item">
                                            <a href="https://www.facebook.com/kyotokimonorentalth/"><?php echo Yii::t('new_kimono_footer', 'Facebook')?></a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                ...
                <div class="mid-footer-menu">
                    <ul class="mid-footer-menu-list">
                        <li class="mid-footer-menu-item">
                            <a href="<?php echo home_url()?>/english-blog"><?php echo Yii::t('new_kimono_footer', '着物レンタルスタッフブログ')?></a>
                        </li>
                        <li class="mid-footer-menu-item">
