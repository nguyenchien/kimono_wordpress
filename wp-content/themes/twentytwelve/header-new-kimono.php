...
<head>
    ...
    <?php elseif($post && $post->post_type == "spot-post" && is_single()): ?>
        <?php
        $area_spot_map = array(
            'shizuoka-area-spot'=>'静岡',

            'sendai-area-spot'=>'仙台',

            'okayama-area-spot'=>'岡山',
            'kurashiki-area-spot' => '岡山',

            'kyoto-area-spot'=>'京都',
            'station-area-spot'=>'京都',
            'gion-area-spot'=>'京都',
            'kiyomizu-area-spot'=>'京都',
            'arashiyama-area-spot'=>'京都',
            'route-spot'=>'京都',

            'osaka-area-spot'=>'大阪',

            'tokyo-area-spot'=>'東京',
            'asakusa-area-spot'=>'東京',
            'ginza-area-spot'=>'東京',
            'shinjuku-area-spot'=>'東京',

            'kanagawa-area-spot'=>'神奈川',
            'kamakura-area-spot'=>'神奈川',

            'kanazawa-area-spot'=>'金沢',
            'fukuoka-area-spot'=>'福岡',
            'sapporo-area-spot'=>'札幌',
            'okinawa-area-spot'=>'沖縄',
        );
        ...
        $titleCustomSpotPost = $post->post_title.' | '.$bigAreaName.'の観光スポット紹介 | wargo';
        ?>
