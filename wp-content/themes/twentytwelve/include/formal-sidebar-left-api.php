...
$post_name = isset($attr['post_name']) ? $attr['post_name'] : '';
$post_parent = isset($attr['post_parent']) ? $attr['post_parent'] : '';
$isSmartPhone = isset($attr['issmartphone']) && $attr['issmartphone'] == 'true' ? true : false;
...
<!--            </li>-->
            <li class="item login-btn">
                <a href="<?php echo WP_HOME ?>/common/login" class="flexbox align-items-center">
                    ...
                    <span class="name"><?php echo Yii::t('new_header_highend', 'ログイン/新規会員登録') ?></span>
                </a>
            </li>
            ...
            <li class="item" style="display: block !important;">
...
<div class="wrap-category scene">
    <div class="title-general text-center title-general-new-style active" data-collapse-cate=".collapse-cate">
        <div class="wrap-title-text flexbox">
            <span class="icon-filter"><img src="<?= WP_HOME; ?>/images/icon-filter.svg" alt=""></span>
    ...
    <div class="box-category collapse-cate" style="display: none;">
        <ul class="list-box-category">
            <li class="item-box-category flexbox">
        ...
        <div class="box-category box-category collapse-cate wrap-filter-new-style">
            <ul class="list-box-category">
                <li class="item-box-category flexbox item-box-category-main">
                    ...
                    <form action="<?php echo $permalink?>" style="display: none;" id="search_product_multiple" method="get" class="box-category collapse-cate">
...
<!--                    <div class="title-category flexbox align-items-center" data-collapse-cate=".product-code-wrapper"><span class="text-category">型番<var>から探す</var></span><span class="arrow"></span></div>-->
                    <div class="title-general text-center title-general-new-style active" data-collapse-cate=".product-code-wrapper">
                        <div class="wrap-title-text flexbox">
                            <span class="icon-filter"><img src="<?= WP_HOME; ?>/images/icon-filter.svg" alt=""></span>
                    ...
                    <div class="product-code-wrapper" style="display: none;">
...
<!--                    <div class="title-category flexbox align-items-center" data-collapse-cate=".shop-wrapper"><span class="text-category">店舗の在庫<var>から探す</var></span><span class="arrow"></span></div>-->
                    <div class="title-general text-center title-general-new-style active" data-collapse-cate=".shop-wrapper">
                        <div class="wrap-title-text flexbox">
                            <span class="icon-filter"><img src="<?= WP_HOME; ?>/images/icon-filter.svg" alt=""></span>
                    ...
                    <div class="shop-wrapper" style="display: none;">
