...
global $language;
if ($language != "ja") {
	include('new-kimono-options-sidebar-'.$language.'.php');
	return;
}
?>
...
<?php
	if(strpos($url,'kamakura-area') == true){?>
		<div class="wrap-topics-banner-widget wrap-kimono-content-sidebar-widget pc">
			<div class="title-general text-center flexbox margin-bt10 justify-content-between"><?= Yii::t('new_kimono_sidebar_right', 'new-kimono-title-contents')?><span class="toggle-icon-arrow "></span></div>
			<div class="wrap-list-banner">
				<ul class="list-banner flexbox">
					<li class="item-banner new-formal-widget-right">
						...
						<p class="text-banner text-banner-right"> <a href="<?= home_url(); ?>/blog"><?= Yii::t('new_kimono_sidebar_right', 'きものレンタルwargo全店舗から、<br>お知らせや店舗の様子をお届けいたします')?></a> </p>
					</li>
					<li class="item-banner new-formal-widget-right">
						<div class="wrap-new-formal-widget-right">
					...
					<li class="item-banner new-formal-widget-right">
						<div class="wrap-new-formal-widget-right">
							<div class="box-icon-new-formal"><span class="icon icon-formal-recommend flexbox"></span></div>
							<div class="wrap-text-new-formal">
								<p class="text-new-formal-1 text-new-kimono-option-title"><?= Yii::t('new_kimono_sidebar_right', '京都おすすめ')?></p>
								<p class="text-new-formal-2 text-new-kimono-option-title-2"><?= Yii::t('new_kimono_sidebar_right', '観光地MAP')?></p>
							</div>
						</div>
						<p class="text-banner text-banner-right"><a href="<?= home_url(); ?>/course"><?= Yii::t('new_kimono_sidebar_right', '着物を着て京都散策♪おすすめの観光地を<br>マップ形式でご紹介します。')?></a></p>
					</li>
					<li class="item-banner new-formal-widget-right">
						<div class="wrap-new-formal-widget-right">
		...
		<div class="wrap-list-banner">
			<ul class="list-banner flexbox">
				...
				<li class="item-banner new-formal-widget-right">
					...
					<p class="text-banner text-banner-right"><a href="<?= home_url(); ?>/spot"><?= Yii::t('new_kimono_sidebar_right', '着物を着て京都散策♪おすすめの観光地を<br>マップ形式でご紹介します。')?></a></p>
				</li>
				<li class="item-banner new-formal-widget-right">
					<div class="wrap-new-formal-widget-right">
						<div class="box-icon-new-formal"><span class="icon icon-formal-faqs-2 flexbox"></span></div>
