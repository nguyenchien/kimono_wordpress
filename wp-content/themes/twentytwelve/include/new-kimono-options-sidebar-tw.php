			...
			<div class="wrap-list-banner">
				<ul class="list-banner flexbox">
					<li class="item-banner new-formal-widget-right">
						...
						<p class="text-banner text-banner-right"> <a href="<?= home_url(); ?>/traditionalchinese-blog"><?= Yii::t('new_kimono_sidebar_right', 'きものレンタルwargo全店舗から、<br>お知らせや店舗の様子をお届けいたします')?></a> </p>
					</li>
					<li class="item-banner new-formal-widget-right">
						<div class="wrap-new-formal-widget-right">
