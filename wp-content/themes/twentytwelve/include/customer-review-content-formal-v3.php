...
//                $customer_name = !empty($customer_name) ? $customer_name : substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), 0, 1).'.'.substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), 0, 1);
                ...
                <li class="box-review">
                        ...
                        <div class="wrap-pd-img">
                            <div class="pd-img">
                                <?php if ($image_product) :?>
                                    ...
                                    ?>
                                    <a href="<?php echo $productDetailLink;?>" class="customer-product-img"><img data-src="<?php echo $newUrl;?>" alt="<?php echo Yii::t('formal.customer_remark', '{plan_type_name}「{product_name}」{product_code}', array('{plan_type_name}' => $planTypeName, '{product_name}' => $productName, '{product_code}' =>  $productCode));?>"></a>
                                <?php else: ?>
                    ...
                    <div class="pd-review">
                        <div class="link-more">
                            <a href="<?php echo $productDetailLink;?>" class="go-detail"><?php echo Yii::t('formal.customer_remark', 'ご利用いただいたお着物');?></a>
                        </div>
                    </div>
                </li>
                <?php
