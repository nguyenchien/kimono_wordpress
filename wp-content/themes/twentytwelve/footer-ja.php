...
if (!is_page('reserve') && !$is_blog_cate && !$is_group_blog):
    ...
    <div id="classroom_banner" class="main-content new-classroom-banner" style='display: <?= $language == "ko" ? "none" : "block"?>' >
        <div class="container clearfix">
	        ...
	        <?php if($page_template_name != 'tourist-spots'): ?>
            <?php
                ...
                <li><a href="<?php echo esc_attr(home_url('column_yukata'))?>">
                        <img src="<?php echo WP_HOME .'/images/banner-column-2-' .$language. '.png';?>" alt=""/>
                    </a></li>
            <?php endif; ?>
            </ul>
        </div>
                    ...
                    <?php if($page_template_name != 'tourist-spots') { ?>
                        <div class="box-social-net-footer clearfix">
                            ...
                            <div class="box-statistical">
	                                ...
	                                echo $listTopReserve;
	                                ?>
                                    <div id="yesterdayCustomerVoice" class="yesterday-customer-voice" style="display: none">
                                        <?php if ($language != "ja"): ?>
                                            <h3 class="title">
                                                <p class="customer-voice-title"><?php echo Yii::t("footer", "着物レンタルwargo<span>昨日のお客様の声</span>"); ?></p>
                                                <span class="cloud-speech customer-voice-datetime <?php echo ($language == 'ja') ? 'cloud-speech-ja' : '';?>"></span>
                                            </h3>
                                        <?php else: ?>
                                            <div class="title title-ja">
                                                <p class="customer-voice-title"><img src="<?php echo get_template_directory_uri(); ?>/images/bg-title-customer-voice.svg" alt="" /></p>
                                                <span class="cloud-speech customer-voice-datetime cloud-speech-ja"></span>
                                            </div>
                                        <?php endif; ?>
                                        <div class="content">
                                            <div class="content-bg">
                                                <span class="content-bg-left"></span>
                                                <span class="content-bg-center"></span>
                                                <span class="content-bg-right"></span>
                                            </div>
                                            <h3 class="voice-title"></h3>
                                            <?php echo do_shortcode( '[yesterday_customer_voices]' ); ?>
                                            <div class="title-footer-top100 title-footer-top100-customer-voices"><?php echo CHtml::link(Yii::t('wp_theme', '予約をする'), array('/reserve')); ?></div>
                                        </div>
                                    </div>
                            </div>
                        </div>
...
<div class="sb-slidebar sb-right">
    ...
    <?php if(!$isSmartPhone && $page_template_name != 'tourist-spots'){ ?>
<!--    <link href="--><?php //echo WP_HOME;?><!--/react/static/css/main.css" rel="stylesheet">-->
        <script id="lazy-calendar">
	        ...
	        // Add Text Customer voice title
	        var cusVoiceCount = '<?= Yii::t("wp_theme", "最新{{cus_voice_count}}件を表示") ?>';
	        if (typeof Mustache != 'undefined') {
		        $('#yesterdayCustomerVoice .voice-title').html(
			        Mustache.render(cusVoiceCount, {
				        cus_voice_count: $('#yesterdayCustomerVoice ul li').length
			        })
		        );
	        }
