            ...
            <div id="box-footer" class="sixteen columns clearfix">
                ...
                <div class="box-social-net-footer clearfix">
                    <?php if($language !='en' && $language !='id' && $language !='fr') { ?>
                        <div class="box-social-net">
                            <div class="sec-facebook">
                                <?php if($language =="ko"){ ?>
                                    <div class="sec-blog-pc">
                                        <span class="button-link-sns button-blog-naver-pc"><a href="http://blog.naver.com/wargo"><img src="<?php echo WP_HOME; ?>/images/SNS-KO/sns-naver-blog-pc.svg"/></a></span>
                                    </div>
                            ...
                            <div class="ins-witter">
                                ...
                                <div class="sec-twitter">
                                    <?php if($language =="ko"){ ?>
                                        <div class="sec-cafe-pc">
                                            <div class="button-cafe-naver-pc"><a href="http://cafe.naver.com/kyotokimono"><img src="<?php echo WP_HOME; ?>/images/SNS-KO/sns-naver-cafe-pc.svg"/></a></div>
                                        </div>
                    ...
                    <div class="box-statistical">
	                    <div class="main-top-100" id="main-top-100"></div>
                    </div>
                    <?php } ?>
                ...
                <div class="box-social-net-footer clearfix">
                        <div class="box-social-net">
                            <div class="sec-item sec-naver-1">
                                <div class="title-social-sns title-naver"><a href="http://cafe.naver.com/kyotokimono"><img src="<?php echo WP_HOME; ?>/images/SNS-KO/sns-naver-01-sp.svg"/></a></div>
                                <div class="button-link button-link-naver"><a href="http://cafe.naver.com/kyotokimono"><img src="<?php echo WP_HOME; ?>/images/SNS-KO/sns-naver-search-01-sp.svg"/></a></div>
                            </div>
                            <div class="sec-item sec-naver-2">
                                <div class="title-social-sns title-naver"><a href="http://blog.naver.com/wargo"><img src="<?php echo WP_HOME; ?>/images/SNS-KO/sns-naver-02-sp.svg"/></a></div>
                                <div class="button-link button-link-naver"><a href="http://blog.naver.com/wargo"><img src="<?php echo WP_HOME; ?>/images/SNS-KO/sns-naver-search-02-sp.svg"/></a></div>
                            </div>
