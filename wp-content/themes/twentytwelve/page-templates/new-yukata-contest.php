<?php
/**
 * Template Name: New Yukata Contest
 *
...
wp_register_style('new-yukata-contest-style', get_template_directory_uri() . '/css/new-yukata-contest.css', array('twentytwelve-style'));
wp_enqueue_style('new-yukata-contest-style');
