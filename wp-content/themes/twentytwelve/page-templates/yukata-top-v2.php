                                ...
                                <div class="right-column right-column-top-v3">
                                    <section class="banner-section">
                                        <ul class="list-banner" id="top-slider">
                                            ...
                                            <?php if ( get_field('main_banner_sp') ) : ?>
                                                <?php echo php_set_base_url(get_field('main_banner_sp')); ?>
                                            <?php endif; ?>
                                    ...
                                    <section class="section-intro">
                                        <div class="wrap-title-6-point">
                                            <p class="title-6-point">wargoを選ぶ
                                                <span><img data-src="<?= WP_HOME ?>/images/new-kimono-v3/text-6-point.svg" alt=""></span>つの理由
                                            </p>
                                        </div>
                                    ...
                                    <section class="section-storelist">
                                        <div class="wrap-title">
                                            ...
                                            <h2 class="sub-title">お近くの浴衣レンタルの店舗を探す</h2>
                                        </div>
                                        <ul class="storelist">
                                            <li>
                                                ...
                                                <div class="store-content">
                                                    <div class="store-img">
                                                        <a href="<?= home_url() ?>/access/kyoto-area/station-area/kyotostation">
                                                            <img data-src="<?= WP_HOME ?>/images/yukata-v2/img-store-sp-01.jpg?ver=20200616" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="store-info">
                                                        <h4 class="store-name">
                                                            <a href="<?= home_url() ?>/access/kyoto-area/station-area/kyotostation">京都タワー店</a>
                                                        </h4>
                                                        <p class="store-desc">京都駅徒歩2分京都タワービル3F</p>
                                            ...
                                            <li>
                                                ...
                                                <div class="store-content">
                                                    <div class="store-img">
                                                        <a href="<?= home_url() ?>/access/kyoto-area/gion-area/gion-shijo">
                                                            <img data-src="<?= WP_HOME ?>/images/yukata-v2/img-store-sp-02.jpg?ver=20200616" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="store-info">
                                                        <h4 class="store-name">
                                                        ...
                                                        <p class="store-desc">祇園四条駅徒歩2分</p>
                                                        <div class="wrap-store-btn">
                                                            <a href="#" class="store-btn show-map">地図を確認する</a>
                                                            <a href="<?= home_url() ?>/access/kyoto-area/gion-area/gion-shijo" class="store-btn link-btn">店舗情報はこちら</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="store-map">
                                                ...
                                                <div class="store-content">
                                                    <div class="store-img">
                                                        <a href="<?= home_url() ?>/access/kyoto-area/arashiyama-area/arashiyama">
                                                            <img data-src="<?= WP_HOME ?>/images/yukata-v2/img-store-sp-03.jpg" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="store-info">
                                                ...
                                                <div class="store-content">
                                                    <div class="store-img">
                                                        <a href="<?= home_url() ?>/access/kyoto-area/arashiyama-area/arashiyama-togetsukyo">
                                                            <img data-src="<?= WP_HOME ?>/images/yukata-v2/img-store-sp-04.jpg" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="store-info">
...
<!--                                                            <img data-src="--><?//= WP_HOME ?><!--/images/yukata-v2/img-store-sp-05.jpg" alt="">-->
<!--                                                        </a>-->
<!--                                                    </div>-->
<!--                                                    <div class="store-info">-->
...
<!--                                                </div>-->
                                                <div class="store-content">
                                                    <div class="store-img">
                                                        <a href="<?= home_url() ?>/access/kyoto-area/kiyomizu-area/kiyomizuzaka">
                                                            <img data-src="<?= WP_HOME ?>/images/yukata-v2/img-store-sp-06.jpg" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="store-info">
                                                        <h4 class="store-name"><a href="<?= home_url() ?>/access/kyoto-area/kiyomizu-area/kiyomizuzaka">清水坂店</a></h4>
                                                        <p class="store-desc">嵐電嵐山駅すぐそば！</p>
                                                        <div class="wrap-store-btn">
                                            ...
                                            <li>
                                                <div class="plan-img">
                                                    <a href="<?= home_url()?>/yukata/plan#Standard-Yukata">
                                                        <img data-src="<?= WP_HOME ?>/images/yukata-v2/yukata-plan-sp-01-v2.jpg" alt="選べるスタンダード浴衣プラン">
                                                        <div class="plan-info">
                                            ...
                                            <li>
                                                <div class="plan-img">
                                                    <a href="<?= home_url()?>/yukata/plan#Couple-Standard-Yukata">
                                                        <img data-src="<?= WP_HOME ?>/images/yukata-v2/yukata-plan-sp-02-v2.jpg" alt="カップル浴衣プラン">
                                                        <div class="plan-info">
                                            ...
                                            <li>
                                                <div class="plan-img">
                                                    <a href="<?= home_url()?>/yukata/plan#Mamechiyo-Yukata">
                                                        <img data-src="<?= WP_HOME ?>/images/yukata-v2/yukata-plan-sp-03-v2.jpg" alt="豆千代モダン浴衣プラン">
                                                        <div class="plan-info">
                                            ...
                                            <li>
                                                <div class="plan-img">
                                                    <a href="<?= home_url()?>/yukata/plan#Brand-Yukata">
                                                        <img data-src="<?= WP_HOME ?>/images/yukata-v2/yukata-plan-sp-04-v2.jpg" alt="ブランド浴衣プラン">
                                                        <div class="plan-info">
                                            ...
                                            <li>
                                                <div class="plan-img">
                                                    <a href="<?= home_url()?>/yukata/plan#Men-Yukata">
                                                        <img data-src="<?= WP_HOME ?>/images/yukata-v2/yukata-plan-sp-05-v2.jpg" alt="メンズ浴衣プラン">
                                                        <div class="plan-info">
                                            ...
                                            <li>
                                                <div class="plan-img">
                                                    <a href="<?= home_url()?>/yukata/plan#Girl-Yukata">
                                                        <img data-src="<?= WP_HOME ?>/images/yukata-v2/yukata-plan-sp-06-v2.jpg" alt="子供浴衣プラン">
                                                        <div class="plan-info">
                                            ...
                                            <li class="item">
                                                <div class="img">
                                                    <a href="<?=home_url() ?>/hairset">
                                                        <img data-src="<?php echo WP_HOME; ?>/images/new-kimono-v3/img-option-v3-02.jpg?ver=12022020" alt="プロのヘアセット師がアレンジ！せっかくだから着物ヘアー">
                                                    </a>
                                                </div>
                                        ...
                                        <div class="wrap-faq">
                                            <div class="faq-content">
                                                <div class="box-faqs-item-container items">
                                                    ...
                                                    <div class="box-faqs-item-content"><p class="text-item-content">特にございません。
                                                            浴衣用の下着や下駄バッグなどはプランに含まれています。<br>
                                                            京都は夏とても暑くなりますので、扇子やカンカン帽のレンタルも行っております。</p>
                                                    </div>
                                                </div>
                                                <div class="box-faqs-item-container items">
                                                    <div class="box-faqs-item flexbox" data-faqs=".box-faqs-item-content">
                                    ...
                                    <section class="section-topic">
                                        <div class="wrap-title">
                                            ...
                                            <h2 class="sub-title">浴衣レンタル人気トピック</h2>
                                        </div>
                                        <ul class="list-topic">
                                            <li>
                                                <div class="img">
                                                    <a href="<?= home_url()?>/formal/whygoodvalue">
                                    ...
                                    <section class="section-spot-ranking">
                                        <div class="wrap-title">
                                            ...
                                            <h2 class="sub-title">浴衣で散策なら絶対に外せない！</h2>
                                        </div>
...
<!--                                                            </li>-->
                                    ...
                                    <section class="section-kimono-column">
                                        <div class="wrap-title">
                                            ...
                                            <h2 class="sub-title">正しく、美しく、浴衣を着るために</h2>
                                        </div>
    ...
    <section class="banner-section">
        <ul class="list-banner" id="top-slider">
            ...
            <?php if ( get_field('main_banner_pc') ) : ?>
                <?php echo php_set_base_url(get_field('main_banner_pc')); ?>
            <?php endif; ?>
        ...
        <div class="container-box">
            ...
            <ul class="shoplist flexbox">
                <li class="shoplist-item">
                    <a href="<?= home_url()?>/access/kyoto-area/station-area/kyotostation" class="shop-link">
                        <h3>京都駅前京都タワー店</h3>
                    </a>
                    <p class="shop-desc">京都駅徒歩2分！</p>
                </li>
                <li class="shoplist-item">
                    <a href="<?= home_url()?>/access/kyoto-area/gion-area/gion-shijo" class="shop-link">
                        <h3>京都祇園四条店</h3>
                    </a>
                    <p class="shop-desc">八坂神社すぐそば♪</p>
                </li>
                <li class="shoplist-item">
                    <a href="<?= home_url()?>/access/kyoto-area/arashiyama-area/arashiyama" class="shop-link">
                        <h3>京都嵐山駅前店</h3>
                    </a>
                    <p class="shop-desc">渡月橋まで徒歩2分</p>
                </li>
                <li class="shoplist-item">
                    <a href="<?= home_url()?>/access/kyoto-area/kiyomizu-area/kiyomizuzaka" class="shop-link">
                        <h3>京都清水坂店</h3>
                    </a>
...
<!--                </li>-->
                <li class="shoplist-item">
                    <a href="<?= home_url()?>/access/kyoto-area/station-area/formal-kyototower" class="shop-link">
                        <h3>フォーマル京都タワー店</h3>
                    </a>
                    <p class="shop-desc">京都随一の冠婚葬祭きもの専門店</p>
                </li>
                <li class="shoplist-item">
                    <a href="<?= home_url()?>/access/kyoto-area/arashiyama-area/arashiyama-togetsukyo" class="shop-link">
                        <h3>京都嵐山渡月橋店</h3>
                    </a>
                    <p class="shop-desc">渡月橋まで徒歩5分</p>
                </li>
                <li class="shoplist-item">
                    <a href="<?= home_url()?>/access/osaka-area/osaka-shinsaibashi-opa" class="shop-link">
                        <h3>大阪心斎橋店</h3>
                    </a>
                ...
                <li class="shoplist-item item-flex other-shop">
                    ...
                    <ul class="other-shop-list">
                        <li>
                            <a href="<?= home_url() ?>/access/kamakura-area/kamakura">鎌倉小町店</a>
                        </li>
                        <li>
                            <a href="<?= home_url() ?>/access/kanazawa-area/kanazawa">金沢店</a>
                        </li>
                        <li>
                            <a href="<?= home_url() ?>/formal/access/tokyo-area/ginza-honten">銀座本店</a>
                        </li>
                        <li>
                            <a href="<?= home_url() ?>/access/tokyo-area/shinjuku-area/shinjuku-station">新宿駅前店</a>
                        </li>
                        <li>
                            <a href="<?= home_url() ?>/access/asakusa-area/asakusa">東京浅草店</a>
                        </li>
                        <li>
                            <a href="<?= home_url() ?>/access/asakusa-area/tokyoskytree">東京スカイツリータウンソラマチ店</a>
                        </li>
                        <li>
                            <a href="<?= home_url() ?>/formal/access/sapporo-area/sapporo-susukinostation">札幌すすきの駅前店</a>
                        </li>
                        <li>
                            <a href="<?= home_url() ?>/access/fukuoka-area/dazaifu">太宰府天満宮前店</a>
                        </li>
<!--                        <li>-->
<!--                            <a href="--><?//= home_url() ?><!--/formal/access/tohoku-area/sendai-parco2">仙台駅前店</a>-->
<!--                        </li>-->
                        <li>
                            <a href="<?= home_url() ?>/access/okayama-area/kurashiki">倉敷美観地区店</a>
                        </li>
                        <!--                        <li>-->
                ...
                <li class="shoplist-item item-flex last">
                    <a href="<?= home_url()?>/access" class="shop-link">空き状況をチェック！</a>
                </li>
            </ul>
        </div>
    </section>
                                    ...
                                    <ul class="storelist">
                                        <li>
                                            ...
                                            <div class="store-content">
                                                <div class="store-img">
                                                    <a href="<?= home_url() ?>/access/kyoto-area/station-area/kyotostation">
                                                        <img data-src="<?= WP_HOME ?>/images/yukata-v2/img-store-pc-01.jpg" alt="">
                                                    </a>
                                                </div>
                                                <div class="store-info">
                                                    <h4 class="store-name">
                                                    ...
                                                    <p class="store-desc">京都駅から徒歩2分！ 京都タワービル3F</p>
                                                    <div class="store-info">
                                        ...
                                        <li>
                                            ...
                                            <div class="store-content">
                                                <div class="store-img">
                                                    <a href="<?= home_url() ?>/access/kyoto-area/gion-area/gion-shijo">
                                                        <img data-src="<?= WP_HOME ?>/images/yukata-v2/img-store-pc-02.jpg" alt="">
                                                    </a>
                                                </div>
                                                <div class="store-info">
                                                    <h4 class="store-name">
                                                        <a href="<?= home_url() ?>/access/kyoto-area/gion-area/gion-shijo">祇園四条店</a>
                                                        <span class="show-map">
                                                            <img data-src="<?= WP_HOME ?>/images/new-kimono-v3/btn-map.svg" alt="">
                                                        </span>
                                                    </h4>
                                                    ...
                                                    <div class="store-info">
                                                        ...
                                                        <p>着付け最終受付時間：18：00</p>
                                                        <p>返却締め切り時間：18：30</p>
                                                        <a href="<?= home_url() ?>/access/kyoto-area/gion-area/gion-shijo" class="access-link">店舗情報</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="store-map">
                                        ...
                                        <li class="two-store">
                                            ...
                                            <div class="store-content">
                                                <div class="store-img">
                                                    <a href="<?= home_url() ?>/access/kyoto-area/arashiyama-area/arashiyama">
                                                        <img data-src="<?= WP_HOME ?>/images/yukata-v2/img-store-pc-03.jpg" alt="">
                                                    </a>
                                                </div>
                                                <div class="store-info">
                                                    <h4 class="store-name">
                                            ...
                                            <div class="store-content last">
                                                <div class="store-img">
                                                    <a href="<?= home_url() ?>/access/kyoto-area/arashiyama-area/arashiyama-togetsukyo">
                                                        <img data-src="<?= WP_HOME ?>/images/yukata-v2/img-store-pc-04.jpg" alt="">
                                                    </a>
                                                </div>
                                                <div class="store-info">
                                                    <h4 class="store-name">
...
<!--                                                <div class="store-img">-->
<!--                                                    <a href="--><?//= home_url() ?><!--/access/kyoto-area/kiyomizu-area/chawanzaka">-->
<!--                                                        <img data-src="--><?//= WP_HOME ?><!--/images/yukata-v2/img-store-pc-05.jpg" alt="">-->
<!--                                                    </a>-->
<!--                                                </div>-->
<!--                                                <div class="store-info">-->
<!--                                                    <h4 class="store-name">-->
...
<!--                                            </div>-->
                                            <div class="store-content last">
                                                <div class="store-img">
                                                    <a href="<?= home_url() ?>/access/kyoto-area/kiyomizu-area/kiyomizuzaka">
                                                        <img data-src="<?= WP_HOME ?>/images/yukata-v2/img-store-pc-06.jpg" alt="">
                                                    </a>
                                                </div>
                                                <div class="store-info">
                                                    <h4 class="store-name">
                                    ...
                                    <div class="wrap-faq">
                                        <div class="faq-content">
                                            <div class="box-faqs-item-container items">
                                                ...
                                                <div class="box-faqs-item-content"><p class="text-item-content">特にございません。 浴衣用の下着や下駄バッグなどはプランに含まれています。 京都は夏とても暑くなりますので、 扇子やカンカン帽のレンタルも行っております。</p></div>
                                            </div>
                                            <div class="box-faqs-item-container items">
                                                <div class="box-faqs-item flexbox" data-faqs=".box-faqs-item-content">
                                                    <div class="box-faqs-title flexbox justify-content-between"><p class="text-faqs-title">キャンセルについて教えてください</p>
    ...
    <section class="section-spot-ranking">
        <div class="container-box">
            <div class="wrap-title-other">
                <p class="main-title">Kimono Spot Ranking</p>
                <h2 class="title">浴衣で散策なら絶対に外せない！</h2>
            </div>
            <div class="wrap-info-spot-ranking">
                <div class="wrap-items-spot-ranking wrap-spot-ranking-01 flexbox">
                    <div class="wrap-img-spot-ranking">
