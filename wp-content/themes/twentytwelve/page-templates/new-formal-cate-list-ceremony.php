            ...
            <div class="container-box">
                <div class="wrap-banner-top">
                    <ul class="list-banner-fm" id="list-banner-fm">
                        <li class="item">
                            <img src="<?= WP_HOME ?>/images/formal-rental/formal-list-v3/banner-ceremony-sp.jpg?ver=20210125" width="750" height="1000" alt="訪問着レンタル 16点フルセット・着付け込み | 結婚式・入学式・卒業式・お宮参り・七五三・お茶会・パーティーに安心のフルセット!">
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <section class="banner-section">
        <div class="container-box">
            <div class="wrap-banner-top">
                <ul class="list-banner-fm" id="list-banner-fm">
                    <li class="item">
                        <img src="<?= WP_HOME ?>/images/formal-rental/formal-list-v3/banner-ceremony-pc.jpg?ver=03022020" alt="訪問着レンタル 16点フルセット・着付け込み | 結婚式・入学式・卒業式・お宮参り・七五三・お茶会・パーティーに安心のフルセット!">
                    </li>
                </ul>
            </div>
        </div>
