...
if($isFrontPage){
    if($isFirefox){
        ...
        if($isSmartPhone){?>
            <link rel="preload" href="<?php echo Yii::app()->getBaseUrl(true)?>/rsrc?page=<?= ResourceMasterValues::RM_KIMONO_TOP_SP_V3?>&ver=<?= $date ?>" as="style" onload="this.onload=null;this.rel='stylesheet'">
            <noscript><link rel="stylesheet" href="<?php echo Yii::app()->getBaseUrl(true)?>/rsrc?page=<?= ResourceMasterValues::RM_KIMONO_TOP_SP_V3?>&ver=<?= $date ?>"></noscript>
            <?php
        } else{
            ?>
            <link rel="preload" href="<?php echo Yii::app()->getBaseUrl(true)?>/rsrc?page=<?= ResourceMasterValues::RM_KIMONO_TOP_PC_V3?>&ver=<?= $date ?>" as="style" onload="this.onload=null;this.rel='stylesheet'">
            <noscript><link rel="stylesheet" href="<?php echo Yii::app()->getBaseUrl(true)?>/rsrc?page=<?= ResourceMasterValues::RM_KIMONO_TOP_PC_V3?>&ver=<?= $date ?>"></noscript>
        <?php }
    }
} elseif ($page_template_name == 'new-access-child-page-v3'){
    if($isFirefox){
