...
?>
<div class="kyoto contact-info two-thirds column omega clearfix <?php echo $flagCollapseContent ? "titlestoresArrow" : ""?>" <?php echo $flagCollapseContent ? 'style="display: none;"' : '' ?>>
	...
	<div class="wrap-cont list-shops clearfix">
		<div class="cont-shops cont-right column one-third omega">
			<?php
				...
				$arashiyama = isset($shopList[MasterValues::SHOP_ARASHIYAMA_ID]) ? $shopList[MasterValues::SHOP_ARASHIYAMA_ID] : '';
				$petit_gionsijo = isset($shopList[MasterValues::SHOP_GIONSHIRAKAWA_ID]) ? $shopList[MasterValues::SHOP_GIONSHIRAKAWA_ID] : '';
				$petit_kyotostation = isset($shopList[MasterValues::SHOP_PETIT_KYOTOSTATION_ID]) ? $shopList[MasterValues::SHOP_PETIT_KYOTOSTATION_ID] : '';
				$arashiyama_togetsukyo = isset($shopList[MasterValues::SHOP_ARASHIYAMA_TOGETSUKYO_ID]) ? $shopList[MasterValues::SHOP_ARASHIYAMA_TOGETSUKYO_ID] : '';
			?>
			<?php
			$addnewtitleenvi = "";
			...
			<div class="shop-item shop-item1 item_footer kyoto-tower row-first">
			    <dl class="shop-1">
...
<!--						<img class="icon-shop-6" src="--><?php //echo WP_HOME;?><!--/images/icons/icon-shop6.png" alt="" />-->
			...
			<?php if (!empty($arashiyama)) { ?>
				<div class="shop-item shop-item11 item_footer row-first clear-mg">
					<dl class="shop-11">
						<dt class="add-new-title <?php echo $addnewtitleenvi; ?>"><a href="<?php echo esc_url( home_url( '/' ).'access/arashiyama' );?>"><var><?php echo Yii::t('wp_theme','嵐山駅前店')?></var>
								<span class="icon-fa-shop-11"></span>
								<span class="text-new-shop-11"><?php echo Yii::t('wp_theme','arashiyama-short-text')?></a>
						</dt>
						<dd>
							<a href="<?php echo esc_url( home_url( '/' ).'access/arashiyama' );?>">
								<dl class="shop-11-info">
						<dd class="add-new-title-shop"><?php echo Yii::t('wp_theme','嵯峨嵐山駅徒歩30秒')?></dd>
						<dd class="address-map" name-shop="嵐山"><?php echo Yii::t('wp_theme','京都市右京区嵯峨天龍寺車道町9-2 2F')?></dd>
						<dd class="bold-new-style"><?php echo $arashiyama['open_time']; ?>-<?php echo $arashiyama['close_time']; ?><br><?php echo Yii::t('wp_theme','※返却時間は{return_time}までです。', array('{return_time}'=>$arashiyama['return_time']))?></dd>
						<dd class="ft-shop-tt-option"><?php echo Yii::t('wp_theme', 'お店への行き方'); ?></dd>
						<dd class="ft-text-goway"><?php echo Yii::t('wp_theme', 'footer_shop_11_instruction');?></dd>
					</dl>
					</a>
					</dd>
					</dl>
			...
			<div class="shop-item shop-item1 item_footer row-first formal-kyoto">
				<dl class="shop-1">
					<dt class="add-new-title <?php echo $addnewtitleenvi; ?>">
						<a href="<?php echo esc_url( home_url( '/' ).'access/formal-kyototower' );?>"><var><?php echo Yii::t('wp_theme','フォーマ<br>ル京都タワー店')?></var>
							<span class="icon-icon-kyoto"></span>
							<span class="text-new-shop-1"><?php echo Yii::t('wp_theme','京都タワー2F 4/28オープン♪')?></span>
						</a>
					</dt>
					<dd>
						<a href="<?php echo esc_url( home_url( '/' ).'access/formal-kyototower' );?>">
							<dl class="shop-1-info">
								<dd class="add-new-title-shop"><?php echo Yii::t('wp_theme','京都駅徒歩2分 京都タワービル2F')?></dd>
								<dd class="address-map" name-shop="フォーマル京都タワー店"><?php echo Yii::t('wp_theme','京都市下京区烏丸通七条下ル東塩小路町721-1<br />京都タワービル2F')?></dd>
								<dd class="bold-new-style"><?php echo $kyotostationShop['open_time']; ?>-<?php echo $kyotostationShop['close_time']; ?><br><?php echo Yii::t('wp_theme','※最終返却{return_time}までです。', array('{return_time}'=>$kyotostationShop['return_time']))?></dd>
								<dd class="ft-shop-tt-option"><?php echo Yii::t('wp_theme', 'お店の生き方'); ?></dd>
								<dd class="ft-text-goway"><?php echo Yii::t('wp_theme', '京都駅より徒歩2分。鳥丸中央口を出て正面の京都タワービル2Fにございます。');?></dd>
							</dl>
						</a>
					</dd>
				</dl>
			</div><!-- end formal-kyoto -->
            <?php endif; ?>

            <?php if (!empty($arashiyama_togetsukyo)) { ?>
                <div class="shop-item shop-item18 item_footer row-first clear-mg">
                    <dl class="shop-18">
                        <dt class="add-new-title <?php echo $addnewtitleenvi; ?>"><a href="<?php echo esc_url( home_url( '/' ).'access/arashiyama-togetsukyo' );?>"><var><?php echo Yii::t('wp_theme_arashiyama_togetsukyo','嵐山渡月橋店')?></var>
                                <span class="icon-fa-shop-18"></span>
                                <span class="text-new-shop-18"><?php echo Yii::t('wp_theme_arashiyama_togetsukyo','渡月橋まで徒歩5分')?></a>
                        </dt>
                        <dd>
                            <a href="<?php echo esc_url( home_url( '/' ).'access/arashiyama-togetsukyo' );?>">
                                <dl class="shop-18-info">
                                    <dd class="add-new-title-shop"><?php echo Yii::t('wp_theme_arashiyama_togetsukyo','京都駅からJR嵯峨野線「嵐電嵐山」駅下車、徒歩 5分。')?></dd>
                                    <dd class="address-map" name-shop="嵐山渡月橋店"><?php echo Yii::t('wp_theme_arashiyama_togetsukyo','嵐電嵐山駅からアクセス楽々、渡月橋まで徒歩5分！！<br>京都市右京区嵯峨天龍寺車道町9-2 2F')?></dd>
                                    <dd class="bold-new-style"><?php echo $arashiyama_togetsukyo['open_time']; ?>-<?php echo $arashiyama_togetsukyo['close_time']; ?><br><?php echo Yii::t('wp_theme','※返却時間は{return_time}までです。', array('{return_time}'=>$arashiyama_togetsukyo['return_time']))?></dd>
                                    <dd class="ft-shop-tt-option"><?php echo Yii::t('wp_theme', 'お店への行き方'); ?></dd>
                                    <dd class="ft-text-goway"><?php echo Yii::t('wp_theme_arashiyama_togetsukyo', '嵐電嵐山駅からアクセス楽々、渡月橋まで徒歩5分！！京都駅から乗換なし、竹林やキモノフォレストなど、嵐山人気観光地へのアクセス抜群。是非wargoにお立ち寄り下さい！');?></dd>
                                </dl>
                            </a>
                        </dd>
                    </dl>
