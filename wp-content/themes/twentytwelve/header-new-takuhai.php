...
//wp_enqueue_style( 'general-header-style' , get_template_directory_uri()  . '/css/general-header.css', array('twentytwelve-style'),$date);
//wp_enqueue_style( 'header-formal-style' , get_template_directory_uri()  . '/css/header-formal.css', array('twentytwelve-style'),$date);
if($isSmartPhone){
    wp_enqueue_style( 'general-header-sp-style' , get_template_directory_uri()  . '/css/general-header-sp.css', array('twentytwelve-style'),$date);
} else{
    wp_enqueue_style( 'general-header-spc-style' , get_template_directory_uri()  . '/css/general-header-pc.css', array('twentytwelve-style'),$date);
}
wp_enqueue_style( 'header-formal-style' , get_template_directory_uri()  . '/css/header-formal.css', array('twentytwelve-style'), $date);
wp_register_style('header-new-takuhai-style', get_template_directory_uri() . '/css/header-new-takuhai.css', array('twentytwelve-style'));
wp_enqueue_style('header-new-takuhai-style');
...
<![endif]-->
<script src="<?php echo WP_HOME; ?>/js/jquery.lazy.min.js" type="text/javascript"></script>
<?php
    wp_head();
...
<div id="page" class="hfeed site">
	...
	<?php
		...
		// Get header by cache
		$is_sp = $isSmartPhone ? "sp" : "pc";
		//$header = Yii::app()->cache->get("header_new_takuhai_{$is_sp}_{$lang}");
		// Detect if header by language cache does not exist
		//if ($header == false) {
			// Init header
        $header = get_header_template(__DIR__,'header_template_new_takuhai');
			//Yii::app()->cache->set("header_new_takuhai_{$is_sp}_{$lang}", $header);
		//}
...
//		ob_start();
//		require('header_template_new_takuhai.php');
//
//		return ob_get_clean();
//	}
?>
        <!--        Lucky Orange-->
        <?php
        $isPageTakuhai = is_page('takuhai');
        ?>
        <?php if($isPageTakuhai):?>
            <script type='text/javascript'>
