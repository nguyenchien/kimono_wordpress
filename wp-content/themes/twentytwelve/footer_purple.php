            ...
            <div class="content clearfix">
                <div class="wrap left">
                    <div class="shop clearfix">
                        ...
                        <ul>
                            ...
                            <li><a href="<?php echo esc_url(home_url($shop_link_list[MasterValues::SHOP_PETIT_KYOTOSTATION_ID])); ?>"><?= Yii::t('wp_theme','プチ京都駅前店'); ?></a></li>
                            <li><a href="<?php echo esc_url(home_url($shop_link_list[MasterValues::SHOP_GIONSHIRAKAWA_ID])); ?>"><?= Yii::t('wp_theme','プチ祇園四条店'); ?></a></li>
                            <li><a href="<?php echo esc_url(home_url($shop_link_list[MasterValues::SHOP_SHINKYOGOKU_ID])); ?>"><?= Yii::t('wp_theme','新京極店'); ?></a></li>
                            <li><a href="<?php echo esc_url(home_url($shop_link_list[MasterValues::SHOP_KYOMIZUZAKA_ID])); ?>"><?= Yii::t('wp_theme','清水坂店'); ?></a></li>
                            <li><a href="<?php echo esc_url(home_url($shop_link_list[MasterValues::SHOP_NINENZAKA_ID])); ?>"><?= Yii::t('wp_theme','二年坂店'); ?></a></li>
                            <li><a href="<?php echo esc_url(home_url($shop_link_list[MasterValues::SHOP_KINKAKUJI_ID])); ?>"><?= Yii::t('wp_theme','金閣寺店'); ?></a></li>
                ...
                <div class="wrap right">
                    <div class="shop clearfix">
                        ...
                        <ul>
                            <li><a href="<?php echo esc_url(home_url($shop_link_list[MasterValues::SHOP_SHINSAIBASHI_ID])); ?>"><?= Yii::t('wp_theme','大阪心斎橋店'); ?></a></li>
                        </ul>
                    </div>
                    <div class="shop clearfix">
