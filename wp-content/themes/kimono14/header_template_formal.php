            ...
            <div class="box-bt-header flexbox">
                ...
                <?php if($post->post_name == "formal"): ?>
                    ...
                    <div class="wrap-logo">
                        <h1>
                            <a href="<?php echo esc_url( home_url( '/formal' ) ); ?>" title="<?php echo Yii::t('wp_theme', '京都上級着物レンタルwargo');?>" rel="home">
                                <img src="<?php echo WP_HOME; ?>/images/formal-rental/logo-sp.png" alt="<?php echo Yii::t('wp_theme', '京都上級着物レンタルwargo');?>" />
                            </a>
                        </h1>
                    </div><!--end wrap-logo-->
                    <?php else: ?>
                    ...
                    <div id="sliderNewHighend" class="flexslider slider-new-highend">
                        <ul class="list-slider-banner slides">
                            <li class="item-slider-banner">
                                <a href="#">
                                    <img class="pc" src="<?php echo WP_HOME; ?>/images/formal-rental/new-formal-banner-pc.jpg" alt=""/>
                                    <img class="sp" src="<?php echo WP_HOME; ?>/images/formal-rental/new-formal-banner-sp.jpg" alt=""/>
                                </a>
                            </li>
                        </ul>
                    </div>
