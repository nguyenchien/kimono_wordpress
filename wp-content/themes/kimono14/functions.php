...
function twentytwelve_scripts_styles() {
    ...
    */
	...
	if ($page_template_name == 'tourist-spots') {
		wp_enqueue_script('tourist-google-map', get_template_directory_uri() . '/js/tourist-google-map.js', array(), '20181201');
	} elseif(!$isSmartPhone){
...
//	wp_enqueue_script( 'twentytwelve-navigation', get_template_directory_uri() . '/js/navigation.js', array( 'jquery' ), '20140318', true );
	...
	wp_enqueue_style( 'style-one-column' , get_template_directory_uri()  . '/css/style-one-column.css', array('twentytwelve-style'),$date);
	wp_enqueue_style( 'style-smartphone',get_template_directory_uri()  . '/css/style-smartphone.css', array(),$date );

	wp_enqueue_style( 'slidebars', get_template_directory_uri()  . '/css/slidebars.css',array(),'20150601' );
	wp_enqueue_style( 'slidebars-custom' , get_template_directory_uri()  . '/css/slidebars-custom.css',array(),'20150601');
...
//	}
	...
	wp_enqueue_style( 'custom-scroll-css', get_template_directory_uri()  . '/css/jquery.mCustomScrollbar.min.css' );
	wp_enqueue_script( 'custom-scroll-js', get_template_directory_uri() . '/js/jquery.mCustomScrollbar.concat.min.js' );
...
<!--			<div class="nav-previous"><?php // previous_posts_link ( __( '<span class="meta-nav">&larr;</span> Older posts', 'twentytwelve' ) ); ?></div>
			...
			<div class="nav-previous"><?php previous_posts_link ( Yii::t('wp_theme', '<span class="meta-nav"><</span> 前の記事へ') ); ?></div>
			<div class="nav-next"><?php next_posts_link( Yii::t('wp_theme', '次の記事へ <span class="meta-nav">></span>') ); ?></div>
