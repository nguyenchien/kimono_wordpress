    ...
    <div class="container">
            ...
            <div class="content clearfix">
                <div class="wrap left">
                    <div class="shop clearfix">
                        ...
                        <ul>
                            ...
                            <li><a href="/<?php echo $shop_link_list[MasterValues::SHOP_GIONSIJO_ID] ?>"><?= Yii::t('wp_theme','祇園四条店'); ?></a></li>
                            ...
                            <li><a href="/<?php echo $shop_link_list[MasterValues::SHOP_ARASHIYAMA_TOGETSUKYO_ID] ?>"><?= Yii::t('wp_theme_arashiyama_togetsukyo','嵐山渡月橋店'); ?></a></li>
                        </ul>
                    </div>
                </div>
                <div class="wrap right">
                    <div class="shop clearfix">
                        ...
                        <ul>
                            <li><a href="/<?php echo $shop_link_list[MasterValues::SHOP_SHINSAIBASHI_ID] ?>"><?= Yii::t('wp_theme','大阪心斎橋店'); ?></a></li>
                        </ul>
                    </div>
                    <div class="shop clearfix">
                        ...
                        <ul>
                            ...
                            <li><a href="/<?php echo $shop_link_list[MasterValues::SHOP_TOKYO_SKYTREE_ID] ?>"><?= Yii::t('wp_footer_tokyo_skytree','東京スカイツリー<br>タウンソラマチ店'); ?></a></li>
                        </ul>
                    </div>
                    <div class="shop clearfix">
        ...
        <div class="box-item contact clearfix">
            ...
            <div class="content clearfix">
                <ul class="clearfix">
                    <li>
                        <p class="text"><?= Yii::t('wp_footer','全国共通コールセンター'); ?><var>（10:00 - 16:00）</var></p>
                ...
                <?php if($isSmartPhone): ?>
                    <ul class="clearfix">
                        <div class="wrap left">
                            ...
                            <li class="clearfix"><p><a href="/reserve#kurotomesode"><?= Yii::t('wp_footer','黒留袖'); ?></a></p></li>
                            <li class="clearfix"><p><a href="/reserve#kimono"><?= Yii::t('wp_footer','観光着物レンタル'); ?></a></p></li>
                        </div>
                        <div class="wrap right">
                            <li class="clearfix"><p><a href="/reserve#irotomesode"><?= Yii::t('wp_footer','色留袖'); ?></a></p></li>
                            <li class="clearfix"><p><a href="/reserve#seijin"><?= Yii::t('wp_footer','振袖'); ?></a></p></li>
