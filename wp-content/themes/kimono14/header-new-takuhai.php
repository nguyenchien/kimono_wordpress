...
<?php */
	...
	$clientScript->registerScriptFile(Yii::app()->baseUrl.'/js/lightbox.js?v=1', null, array('defer'=>1));
	$clientScript->registerCssFile(Yii::app()->baseUrl.'/css/lightbox.css');
	$clientScript->registerScript('lightBox',  'setLightBox();');
	/* End lightBox*/
