...
?>
        ...
        <?php while (have_posts()) : the_post(); ?>
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                ...
                $language = Yii::app()->language;
                 ?>
                    <div class="box-banner-graphic"><img src="<?php echo WP_HOME; ?>/images/banner-graphic-kimono-petit-<?php echo $language; ?>.png" alt="<?php echo Yii::t('wp_theme','着付け代無料!全てセット'); ?>" /></div>
	...
	<div class="petit_notify"><?php echo Yii::t('wp_theme', 'petit_notify'); ?></div>
		...
		<div class="change-shop-tab peptit-add-plan-container" style="margin-bottom: 20px;">
            <h2 class="title"><?php //echo Yii::t('wp_theme', '店舗で選べる着物一覧'); ?></h2>
        </div>
        -->
