            ...
            <div class="input-person-container">
                <div class="wrap-dx-flex wrap-dx-flex-button-petit">
                    <div class="col-input-left button-new-shop">
                        <a class="button-regular" href="<?php echo esc_url(home_url('/kimono')); ?>"><img alt="<?php echo Yii::t('wp_theme','banner-regular-alt');?>" src="<?php echo Yii::t('wp_theme','banner-regular-src'); ?>"></a>
                    </div>
                    <div class="col-input-right button-new-shop">
                        <a class="button-vip" href="<?php echo esc_url(home_url('/vip')); ?>"><img alt="<?php echo Yii::t('wp_theme','banner-vip-alt');?>" src="<?php echo Yii::t('wp_theme','banner-vip-src') ?>"></a>
                    </div>
