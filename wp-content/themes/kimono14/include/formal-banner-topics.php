<div class="wrap-topics-banner-widget">
    <?php if($attrShortCode['direction'] == "right"): ?>
        <h2 class="title-general text-center flexbox margin-bt10 justify-content-between">
    ...
    <div class="wrap-list-banner">
        <ul class="list-banner flexbox">
            <?php if($attrShortCode['direction'] == "left"): ?>
                <li class="item-banner">
                    <div class="image-banner">
                        <a href="/"><img data-src="<?= WP_HOME ?>/images/formal-rental/banner-topic-formal-01.jpg" alt="京都・大阪・金沢・浅草・鎌倉等の<br>人気観光地で街着のレンタルします。"></a>
                    </div>
                    <p class="text-banner">
                ...
                <li class="item-banner">
                    <div class="image-banner">
                        <a href="/takuhai"><img data-src="<?= WP_HOME ?>/images/formal-rental/banner-topic-formal-02.jpg" alt="全国どこでも【送料無料】 で<br>冠婚葬祭用のお着物を発送致します。"></a>
                    </div>
                    <p class="text-banner">
                ...
                <?php else: ?>
                    <li class="item-banner">
                        <div class="image-banner">
                            <a href="/formal"><img data-src="<?= WP_HOME ?>/images/takuhai/banner-topic-takuhai-02.jpg" alt="ご結婚式、ご入学式、卒業式、七五三<br>など、各種式典やイベントに。"></a>
                        </div>
                        <p class="text-banner">
            ...
            <?php elseif($attrShortCode['direction'] == "right"): ?>
                <li class="item-banner">
                    <div class="image-banner">
                        <a href="/blog"><img data-src="<?= WP_HOME ?>/images/formal-rental/banner-topic-formal-04.jpg" alt="きものレンタルwargo全店舗から、<br>お知らせや店舗の様子をお届けいたします"></a>
                    </div>
                    <p class="text-banner">
                ...
                <li class="item-banner">
                    <div class="image-banner">
                        <a href="/column"><img data-src="<?= WP_HOME ?>/images/formal-rental/banner-topic-formal-05.jpg" alt="着物に関する知識のほか、着物をお洒落に<br>着こなすためのアドバイスなどを多数掲載"></a>
                    </div>
                    <p class="text-banner">
                ...
                <li class="item-banner">
                    <div class="image-banner">
                        <a href="/column_yukata"><img data-src="<?= WP_HOME ?>/images/formal-rental/banner-topic-formal-06.jpg" alt="浴衣に関する知識のほか、浴衣をお洒落に<br>着こなすためのアドバイスなどを多数掲載"></a>
                    </div>
                    <p class="text-banner">
                ...
                <li class="item-banner">
                    <div class="image-banner">
                        <a href="/formal/howto"><img data-src="<?= WP_HOME ?>/images/formal-rental/banner-topic-formal-07.jpg" alt="初めての方でもご安心♪ご予約から当日の<br>レンタルまでの流れをご説明いたします。"></a>
                    </div>
                    <p class="text-banner">
