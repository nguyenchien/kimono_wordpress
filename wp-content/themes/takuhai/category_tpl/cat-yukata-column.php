	...
	<div class="column-list-page clearfix hd-page-template hd-column-list content-column-page page-<?php echo $kimono['parent']->slug; ?>">
		<header <?php echo(empty($category_data['img_src']))?'class="no-img"':'' ?>>
			<div class="image">	
				...
				<?php else:
				$img_src = get_field('cate_img_src', $kimono['parent']);
				?>
								...
								<div class="h3-block page-item">
									...
									<div class="imageleft">
										<?php if (has_post_thumbnail()): ?>
											<?php the_post_thumbnail('spot-thumb', array('alt' => strip_tags(get_the_title()),)) ?>
										<?php endif; ?></div>
									<div class="excerpt"><?php the_excerpt(); ?></div>
									<p class="readmore"><a class="hd-btn page-link" href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php _e('続きを読む', 'twentytwelve'); ?></a>
									</p>
								</div>
							<?php endwhile;
							?>	
